...
<a href="{{ route('supports.index') }}" class="button shadow bg-gray-500 hover:bg-gray-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded">
    <span>Voltar</span>
</a>
